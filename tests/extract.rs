...
fn clip01_matches() {
    ...
    assert_eq!(
        ...
        expected(
            "clip01",
            &[
                "idx=0;aln_len=14732,0;qlen=14925,0,141;mapq=1,0",
                "idx=1;aln_len=14732,0;qlen=14774,0,292;mapq=1,0",
            ]
        )
    );
}
...
fn join01_matches() {
    ...
    assert_eq!(
        ...
        expected(
            "join01",
            &["idx=0;aln_len=16881,2475;qlen=16848,15,2474;mapq=60,60"]
        )
    );
}
...
fn join02_matches() {
    ...
    assert_eq!(
        ...
        expected(
            "join02",
            &["idx=0;aln_len=16879,26284;qlen=16808,1,26163;mapq=60,60"]
        )
    );
}
...
fn join03_matches() {
    ...
    assert_eq!(
        ...
        expected(
            "join03",
            &["idx=0;aln_len=29505,5668;qlen=29436,1,5661;mapq=60,60"]
        )
    );
}
...
fn min_aln_len_drops_one_hit() {
    ...
    assert_eq!(
        ...
        "chr22\t22131975\t<.\t.\t.\tm84039_230117_233243_s1/257233489/ccs\t60\t+\
         \tidx=0;aln_len=16881,0;qlen=16848,0,2489;mapq=60,0\n"
    );
}
...
fn paf_keeps_inversion() {
    ...
    let expected = "\
chr10\t91443587\t<>\tchr10\t91446029\tm84039_230117_233243_s1/251662187/ccs\t60\t-\tidx=0;aln_len=2443,19097;qlen=2926,0,19078;mapq=60,60
chr10\t91443587\t><\tchr10\t91446029\tm84039_230117_233243_s1/251662187/ccs\t60\t-\tidx=1;aln_len=485,2443;qlen=485,0,21519;mapq=60,60
";
